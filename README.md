...
├── test_framework_v4.py         # 종합 테스트 스위트 (9개 테스트 함수)
├── test_scenarios_v47.py        # [v4.7] 시나리오 테스트 (14개 테스트 함수)
├── test_v51_lightrag_features.py # [v5.1] LightRAG 기능 테스트 (5개 테스트 함수)
├── test_v60_features.py         # [v6.0] v6.0 기능 통합 테스트 (8개 테스트 함수)
...
> 권장: 워크스페이스 루트 가상환경 `d:/소스테스트/Azure-openai-sample/venv` 기준으로 실행

```bash
# 전체 테스트 (36개, 4개 파일)
pytest test_framework_v4.py test_scenarios_v47.py test_v51_lightrag_features.py test_v60_features.py -v

# 특정 테스트 파일만
pytest test_framework_v4.py -v          # 기본 모듈 테스트 (9개)
pytest test_scenarios_v47.py -v         # v4.7 시나리오 테스트 (14개)
pytest test_v51_lightrag_features.py -v # v5.1 LightRAG 테스트 (5개)
pytest test_v60_features.py -v          # v6.0 기능 테스트 (8개)
...
- `pytest test_framework_v4.py test_scenarios_v47.py test_v51_lightrag_features.py test_v60_features.py -v`: **36 통과** / 0 실패
  - `test_framework_v4.py`: 9개 테스트 (Azure Clients, MultiModel, Parser, Korean Tokenizer, Agent, Guardrails, ChunkLogger, VectorStore, SearchMapping)
  - `test_scenarios_v47.py`: 14개 테스트 (Config, GraphRAG, Security, EdgeQuake, Guardrails, Hooks, Streaming, ErrorRecovery, WebTools, Parsing, CLI, AgentSecurity, ThreadPool, CrossModule)
  - `test_v51_lightrag_features.py`: 5개 테스트 (Reranker, LLMCache, RAGAS, Config, AgentIntegration)
  - `test_v60_features.py`: 8개 테스트 (Config v6.0, SemanticCache, ResponsesAPI, ContentUnderstanding, Neo4j, AgenticRetrieval, PromptCaching, CrossModule)
- `python run_guardrail_scenarios.py`: 4개 시나리오 모두 통과
- Python 가상환경: `d:\소스테스트\Azure-openai-sample\venv` (Python 3.11.9)
...
#### `pytest test_framework_v4.py test_scenarios_v47.py test_v51_lightrag_features.py -v`

```text
test_framework_v4.py::test_azure_clients PASSED
test_framework_v4.py::test_multi_model_manager PASSED
test_framework_v4.py::test_parser PASSED
test_framework_v4.py::test_korean_tokenizer PASSED
test_framework_v4.py::test_agent_v4 PASSED
test_framework_v4.py::test_guardrail_scenarios PASSED
test_framework_v4.py::test_chunk_logger PASSED
test_framework_v4.py::test_vector_store PASSED
test_framework_v4.py::test_search_runtime_mapping PASSED
test_scenarios_v47.py::test_s1_config_v47 PASSED
test_scenarios_v47.py::test_s2_graph_rag_core PASSED
...
test_v51_lightrag_features.py::test_reranker PASSED
test_v51_lightrag_features.py::test_llm_cache PASSED
test_v51_lightrag_features.py::test_ragas_evaluator_structure PASSED
test_v51_lightrag_features.py::test_config_v51 PASSED
test_v51_lightrag_features.py::test_agent_integration PASSED
