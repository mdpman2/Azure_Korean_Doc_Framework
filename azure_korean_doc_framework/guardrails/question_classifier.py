...
class QuestionClassifier:
    ...
    # 단위 문자(%, 원, 회)는 숫자(또는 만/억/조 등 금액 단위) 뒤에 올 때만 규정형으로
    # 인식하여 '회사'·'직원'·'병원' 등 일반 단어의 부분 매칭에 의한 오분류를 방지합니다.
    REGULATORY_PATTERNS = [r"몇", r"횟수", r"주기", r"기간", r"기준", r"\d\s*%", r"[\d만억조천백]\s*원", r"\d\s*회"]
