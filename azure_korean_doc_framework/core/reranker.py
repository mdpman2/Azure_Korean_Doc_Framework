...
class Reranker:
    ...
    def __init__(
        ...
        try:
            ...
            # 알 수 없는 백엔드 값이 와도 에이전트 초기화가 깨지지 않도록 안전하게 비활성화
            print(f"   ⚠️ 알 수 없는 reranker 백엔드 '{backend}' → 비활성화(none)")
    ...
    def _get_cross_encoder(self):
        ...
        try:
            ...
            print("   ⚠️ sentence-transformers 로드 실패. uv pip install sentence-transformers")
