    ...
    def get_completion(
        ...
        try:
            ...
            try:
                ...
                # 일부 추론 모델(o3/o4-mini 등)은 기본값 외 temperature를 거부합니다(400).
                # temperature 관련 오류일 때만 해당 파라미터를 제거하고 1회 재시도합니다.
                if "temperature" in str(e).lower() and "temperature" in completion_params:
                    print("   ⚠️ 모델이 temperature를 지원하지 않아 제거 후 재시도합니다.")
