...
class AdaptiveChunker:
    ...
    def __init__(self, config: Optional[ChunkingConfig] = None):
        ...
        # Contextual Retrieval용 LLM (GPT-4o)
...
The following is a section from a document named '{filename}'.
...
Context Explanation:"""
            ...
            context = chain.invoke({"filename": filename, "chunk_text": chunk_text})
